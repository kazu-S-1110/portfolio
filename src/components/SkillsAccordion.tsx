...
export const SkillsAccordion = () => {
  return (
    <div className="flex justify-end container px-4 mx-auto">
      <Accordion type="single" collapsible className="inline-flex">
        <AccordionItem value="skills" className="border-b-0">
          <AccordionTrigger className="text-primary px-3 py-2 gap-2 h-8">
            More...
          </AccordionTrigger>
          <AccordionContent className="container mx-auto px-4 absolute left-0 right-0">
